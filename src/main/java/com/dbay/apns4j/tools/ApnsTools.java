...
public class ApnsTools {
	...
	@Deprecated
	public static byte[] generateData(int id, int expire, byte[] token,
			byte[] payload) {
		ByteArrayOutputStream bos = new ByteArrayOutputStream();
		DataOutputStream os = new DataOutputStream(bos);
		try {
	...
	private static String[]	hexArr	= new String[] { "0", "1", "2", "3", "4",
	...
	public static SocketFactory createSocketFactory(InputStream keyStore,
